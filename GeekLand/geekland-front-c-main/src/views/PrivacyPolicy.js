...
export default class PrivacyPolicy extends React.Component {
    ...
    render() {
        return (
            ...
            <u><h2>Politique de confidentialité</h2></u>
            </div>
            <br/><br/><br/><br/>
            
             

La présente Politique de confidentialité décrit la façon dont vos informations personnelles sont recueillies, utilisées et partagées lorsque vous vous rendez sur www.geekland.fr (le « Site ») ou que vous y effectuez un achat.
<br/><br/>
...
<br/><br/>
_aucune donnée retenue, persiste pendant 30 minutes depuis la dernière visite. Utilisé par le système interne de suivi des statistiques du fournisseur de notre site web pour enregistrer le nombre de visites.
<br/><br/>
_aucune donnée retenue, expire à minuit (selon l’emplacement du visiteur) le jour suivant. Calcule le nombre de visites d’une boutique par client unique.
<br/><br/>
...
<br/><br/>
<u>COMMENT UTILISONS-NOUS VOS INFORMATIONS PERSONNELLES ?</u>
<br/><br/>
...
[[INSÉRER LES AUTRES UTILISATIONS QUI SONT FAITES DES INFORMATIONS SUR L'APPAREIL, NOTAMMENT EN MATIÈRE DE PUBLICITÉ ET DE RECIBLAGE]]
...
PUBLICITÉ COMPORTEMENTALE<br/><br/>
...
INCLURE LES LIENS DE DÉSACTIVATION DES SERVICES UTILISÉS.
  QUELQUES LIENS COURANTS :<br/><br/>
    FACEBOOK – https://www.facebook.com/settings/?tab=ads<br/><br/>
...
NOUS CONTACTER
Pour en savoir plus sur nos pratiques de confidentialité, si vous avez des questions ou si vous souhaitez déposer une réclamation, veuillez nous contacter par e-mail à mikej.afci@gmail.com, ou par courrier à l'adresse suivante :
<br/><br/>
 12 rue Anselme, Saint Ouen, paris, 93400, France
